export default function AboutContent({ title, description, btnText }) {
  ...
  return (
    <div className="flex flex-col max-w-[1086px] pt-6">
      ...
      <button className="w-[350px] h-[88px] rounded-[10px] border-solid border-[5px] border-[var(--green-grey)] flex items-center justify-center text-4xl uppercase tracking-[0.15em]">
        {btnText}
      </button>
    </div>
  );
