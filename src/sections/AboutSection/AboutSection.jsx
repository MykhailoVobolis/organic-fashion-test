...
export default function AboutSection() {
  ...
  return (
    <section
      id="about"
      className="pt-[27px] pb-[90px] tablet:pt-[68px] tablet:pb-[46px] medium:pt-[107px] medium:pb-[128px] desktop:pt-[160px] desktop:pb-[103px]">
      <div className="flex flex-col max-w-[280px] ml-auto mr-auto justify-between tablet:flex-row tablet:max-w-[852px] medium:max-w-[1135px] desktop:max-w-[1700px] ">
        {isTablet && (
          <ResponsiveImage
            image={image}
