...
export default function HeroSection() {
  ...
  return (
    <section
      id="home"
      className="pt-[19px] pb-[49px] tablet:pt-[46px] tablet:pb-[101px] laptop:pt-[44px] laptop:pb-[144px]  desktop:pt-[63px] desktop:pb-[204px]">
      {!isTablet && <HeroTitle title={title} />}
      <div className="flex flex-row-reverse tablet:flex-row ml-auto mr-auto justify-between tablet:max-w-[866px] laptop:max-w-[1044px] desktop:max-w-[1620px]">
        <ResponsiveImage
          image={image}
